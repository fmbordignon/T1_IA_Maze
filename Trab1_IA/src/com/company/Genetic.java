            ...
            for (int i = 0; i < 200; i++) {
                ...
                for (int j = 0; j < agentes.length; j++) {
                    ...
                    if (notas[j] > maiorNota) {
                        segundoMelhorAgente = melhorAgente;
                        melhorAgente = j;
                        segundaMaiorNota = maiorNota;
                        maiorNota = notas[j];
                    } else {
                        if (notas[j] > segundaMaiorNota) {
                            segundoMelhorAgente = j;
                            segundaMaiorNota = notas[j];
                        }
                    }
                ...
                geracaoAux[1] = agentes[segundoMelhorAgente].clone();
                notas[0] = maiorNota;
                notas[1] = segundaMaiorNota;

                System.out.println("Criando geracao numero " + (i + 1) + "...");

                for (int j = 2; j < agentes.length; j++) {
                    Random r1 = new Random();
                    Random r2 = new Random();

                    String[] pai = agentes[r1.nextInt(POPULACAO)].clone();
                    String[] mae = agentes[r2.nextInt(POPULACAO)].clone();
                ...
                for (int j = 1; j < agentes.length; j++) {
                    ...
                    if (mutacao.nextInt(100) >= 10) {
                        agentes[j] = mutacao(agentes[j].length, agentes[j]);
                    }
                }
                ...
                System.out.println();
//            printAgente(agentes[1]);
//            System.out.println("Nota : " + notas[1]);
//            System.out.println("Posicao : " + segundoMelhorAgente);
                melhorAgente = 0;
                segundoMelhorAgente = 1;
...
//            System.out.println(" ANTERIOR " + path[moves - 1] + " ATUAL " + path[moves] + " CICLO? "  + b);
        ...
        private static String[] mutacao(int caminhoSize, String[] path) {
            Random mutacao = new Random();
            Random r1 = new Random();
            int a;
            for (int j = 0; j < caminhoSize; j++) {
